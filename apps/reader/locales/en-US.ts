export default {
  ...
  'typography.flow': 'Flow',
  'typography.flow.paginated': 'paginated',
  'typography.flow.scrolled': 'scrolled',
  // 'typography.flow.scrolled_continuous': 'scrolled-continuous',
  // 'typography.flow.scrolled_doc': 'scrolled-doc',
